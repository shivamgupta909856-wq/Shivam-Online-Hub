  ...
  return (
    <main className="service-detail-page">
      ...
      <section className="service-detail-hero">
        ...
        <h1>
          Caste <span>Certificate</span>
        </h1>

        <p>
          Caste Certificate के लिए online application,
          document guidance और application assistance यहाँ उपलब्ध है।
        </p>
      ...
      <section className="service-detail-container">
        ...
        <div className="service-detail-card">
          ...
          <p>
            Caste Certificate एक सरकारी प्रमाण-पत्र है जो
            व्यक्ति की जाति से संबंधित जानकारी को प्रमाणित करता है।
            इसका उपयोग विभिन्न सरकारी योजनाओं, शिक्षा, admission,
            scholarship और अन्य कार्यों में किया जा सकता है।
          </p>
        ...
        <div className="service-detail-card">
          ...
          <ul>
            <li>📝 Caste Certificate application में सहायता</li>
        ...
        <div className="service-detail-card">
          ...
          <ul>
            ...
            <li>📜 Caste से संबंधित उपलब्ध प्रमाण</li>
            <li>📱 Mobile number</li>
